...
- **No approval/triage gate before disputing.** Confido's own production app appears to have an approve/reject triage step before a deduction becomes a dispute candidate. This tool goes straight from "flagged as disputable" to "dispute filed," which is a reasonable simplification at this scale but wouldn't hold up with a shared queue across multiple analysts.
